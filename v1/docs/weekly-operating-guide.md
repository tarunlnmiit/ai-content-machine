...
|------|---------------|-----|
| **Every thumbnail must have a face** | thursday.md Step 3 | Face thumbnails get 5–8% CTR; text-only get 0.3–1.1% |
| **Hook text: 3–5 words, specific result or mistake** | thursday.md Step 3, tuesday.md Step 2d | Generic titles fail; specific hooks drive clicks |
| **No series numbers in titles or thumbnails** | thursday.md Step 4, tuesday.md Step 2d | "Tutorial 1/10" signals commitment — kills cold clicks |
...
| **Shorts produced alongside every long-form** | thursday.md Step 5–6 | Shorts are outperforming long-form across all 3 channels |

**Status (audit date 2026-06-18):**
- @breathofdatascience: CTR 0.3–0.7% → thumbnail replacement backlog in `docs/thumbnail-replacement-backlog.md`
...
- Full per-step posting flow: `docs/daily/friday.md` and `docs/weekly-runner.md` Step 22.
...
the image by hand when you post IG/FB/Threads manually (see `docs/daily/friday.md`).
